...
/*   Updated: 2020/04/25 21:51:26 by xamartin         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	print_mtl(t_mtl *mtl)
{
	...
	printf("\n--------------------------------------------------\nshading: code illum\n\n");
	if (mtl->shading)
		printf("type = %d | group_id %d\t", mtl->shading->type, mtl->shading->group_id);
	printf("\n--------------------------------------------------\ngroup: code newmtl\n\n");
	if (mtl->nb_groups)
	{
		int i = -1;
